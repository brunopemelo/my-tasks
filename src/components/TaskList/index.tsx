...
import { Alert, FlatList, TouchableOpacity, Text, StyleSheet } from 'react-native';
...
export const TaskList = () => {
    ...
    return (
        <FlatList data={tasks as unknown as ITask[]} keyExtractor={item => item.id} renderItem={({ item }) => (
